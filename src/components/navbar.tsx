...
const Navbar: React.FC<NavbarProps> = ({ onFiltersChange }) => {
  ...
  const specializationOptions = [
    'Stress Relief', 'Sports Therapy', 'Beauty Treatment', 'Weight Management',
    'Pain Management', 'Rehabilitation', 'Wellness Coaching', 'Skin Care',
    'Hair Treatment', 'Meditation', 'Yoga Therapy', 'Nutrition Planning'
  ];
  ...
  const handleSpecializationToggle = (specialization: string) => {
    const newSpecializations = advancedFilters.specializations.includes(specialization)
  ...
  const DropdownSelect = ({ options, value, onChange, placeholder, icon: Icon }: any) => (
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <DropdownSelect
              ...
              onChange={(value: string) => handleFilterChange('serviceType', value)}
            ...
            <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    {[1, 2, 3, 4, 5].map(star => (
                      <button
                        key={star}
                        onClick={() => handleAdvancedFilterChange('rating', star)}
              ...
              <div>
                <label className="block text-sm font-medium text-foreground mb-2">
                  Price Range: {currencyOptions.find(c => c.value === filters.currency)?.symbol}{advancedFilters.priceRange[0]} - {currencyOptions.find(c => c.value === filters.currency)?.symbol}{advancedFilters.priceRange[1]}
                </label>
                <div className="flex items-center gap-4">
                  <input
                    ...
                    onChange={(e) => handleAdvancedFilterChange('priceRange', [parseInt(e.target.value), advancedFilters.priceRange[1]])}
                    className="flex-1"
                  />
                  <input
                    type="range"
                    ...
                    onChange={(e) => handleAdvancedFilterChange('priceRange', [advancedFilters.priceRange[0], parseInt(e.target.value)])}
                    className="flex-1"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleAdvancedFilterChange('responseTime', e.target.value)}
                    className="w-full px-3 py-2 bg-background border border-border rounded-lg text-foreground focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    style={{
                      colorScheme: 'dark light',
                      backgroundColor: 'var(--background)',
                  ...
                  >
                    <option value="" style={{backgroundColor: 'var(--background)', color: 'var(--foreground)'}}>Any Response Time</option>
                    <option value="immediate" style={{backgroundColor: 'var(--background)', color: 'var(--foreground)'}}>Within 1 hour</option>
                    <option value="fast" style={{backgroundColor: 'var(--background)', color: 'var(--foreground)'}}>Within 3 hours</option>
                    <option value="same-day" style={{backgroundColor: 'var(--background)', color: 'var(--foreground)'}}>Same day</option>
                    <option value="next-day" style={{backgroundColor: 'var(--background)', color: 'var(--foreground)'}}>Next day</option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleAdvancedFilterChange('workingHours', e.target.value)}
                    className="w-full px-3 py-2 bg-background border border-border rounded-lg text-foreground focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    style={{
                      colorScheme: 'dark light',
                      backgroundColor: 'var(--background)',
                  ...
                  >
                    <option value="" style={{backgroundColor: 'var(--background)', color: 'var(--foreground)'}}>Any Hours</option>
                    <option value="24-7" style={{backgroundColor: 'var(--background)', color: 'var(--foreground)'}}>24/7 Available</option>
                    <option value="business" style={{backgroundColor: 'var(--background)', color: 'var(--foreground)'}}>Business Hours</option>
                    <option value="evening" style={{backgroundColor: 'var(--background)', color: 'var(--foreground)'}}>Evening Hours</option>
                    <option value="weekend" style={{backgroundColor: 'var(--background)', color: 'var(--foreground)'}}>Weekend Available</option>
                    <option value="flexible" style={{backgroundColor: 'var(--background)', color: 'var(--foreground)'}}>Flexible Hours</option>
                  </select>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => handleAdvancedFilterChange('verified', e.target.checked)}
